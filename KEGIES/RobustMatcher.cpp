...
cv::Mat RobustMatcher::match( cv::Mat& image1, cv::Mat& image2, /* input images */ std::vector<cv::DMatch>& matches, /* output matches and keypoints */ std::vector<cv::KeyPoint>& keypoints1, std::vector<cv::KeyPoint>& keypoints2 )
{
